...
/* harmony import */ var _pages_station_station_edit_station_edit_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./pages/station/station-edit/station-edit.component */ "./src/app/pages/station/station-edit/station-edit.component.ts");
/* harmony import */ var _pages_node_node_edit_node_edit_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./pages/node/node-edit/node-edit.component */ "./src/app/pages/node/node-edit/node-edit.component.ts");
/* harmony import */ var _pages_station_station_config_station_config_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./pages/station/station-config/station-config.component */ "./src/app/pages/station/station-config/station-config.component.ts");
/* harmony import */ var _pages_node_node_config_node_config_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./pages/node/node-config/node-config.component */ "./src/app/pages/node/node-config/node-config.component.ts");
...
var routes = [
    {
        ...
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]],
        children: [
            { path: 'config/:dealerId', component: _pages_station_station_config_station_config_component__WEBPACK_IMPORTED_MODULE_26__["StationConfigComponent"] },
            { path: 'edit/:dealerId/:stationId', component: _pages_station_station_edit_station_edit_component__WEBPACK_IMPORTED_MODULE_24__["StationEditComponent"] },
        ]
    }, {
        path: 'node',
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]],
        children: [
            { path: 'config/:dealerId', component: _pages_node_node_config_node_config_component__WEBPACK_IMPORTED_MODULE_27__["NodeConfigComponent"] },
            { path: 'edit/:dealerId/:nodeId', component: _pages_node_node_edit_node_edit_component__WEBPACK_IMPORTED_MODULE_25__["NodeEditComponent"] },
        ]
    }, {
        path: 'user',
        canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]],
...
/* harmony import */ var _pages_dealer_dealer_information_dealer_information_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./pages/dealer/dealer-information/dealer-information.component */ "./src/app/pages/dealer/dealer-information/dealer-information.component.ts");
/* harmony import */ var _pages_dealer_dealer_config_notification_dealer_config_notification_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./pages/dealer/dealer-config-notification/dealer-config-notification.component */ "./src/app/pages/dealer/dealer-config-notification/dealer-config-notification.component.ts");
/* harmony import */ var _pages_user_user_list_user_list_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./pages/user/user-list/user-list.component */ "./src/app/pages/user/user-list/user-list.component.ts");
/* harmony import */ var _pages_user_user_create_user_create_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./pages/user/user-create/user-create.component */ "./src/app/pages/user/user-create/user-create.component.ts");
/* harmony import */ var _pages_user_user_edit_user_edit_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./pages/user/user-edit/user-edit.component */ "./src/app/pages/user/user-edit/user-edit.component.ts");
/* harmony import */ var _pages_dashboard_car_dashboard_car_dashboard_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./pages/dashboard/car-dashboard/car-dashboard.component */ "./src/app/pages/dashboard/car-dashboard/car-dashboard.component.ts");
/* harmony import */ var _pages_dashboard_car_timeline_car_timeline_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./pages/dashboard/car-timeline/car-timeline.component */ "./src/app/pages/dashboard/car-timeline/car-timeline.component.ts");
/* harmony import */ var _pages_dashboard_car_config_notification_car_config_notification_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./pages/dashboard/car-config-notification/car-config-notification.component */ "./src/app/pages/dashboard/car-config-notification/car-config-notification.component.ts");
/* harmony import */ var _pages_menu_menu_menu_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./pages/menu/menu/menu.component */ "./src/app/pages/menu/menu/menu.component.ts");
/* harmony import */ var _pages_data_data_export_data_export_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./pages/data/data-export/data-export.component */ "./src/app/pages/data/data-export/data-export.component.ts");
/* harmony import */ var _pages_beacon_beacon_list_beacon_list_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./pages/beacon/beacon-list/beacon-list.component */ "./src/app/pages/beacon/beacon-list/beacon-list.component.ts");
/* harmony import */ var _pages_beacon_beacon_register_beacon_register_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./pages/beacon/beacon-register/beacon-register.component */ "./src/app/pages/beacon/beacon-register/beacon-register.component.ts");
/* harmony import */ var _pages_beacon_beacon_edit_beacon_edit_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./pages/beacon/beacon-edit/beacon-edit.component */ "./src/app/pages/beacon/beacon-edit/beacon-edit.component.ts");
/* harmony import */ var _pages_car_car_register_car_register_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./pages/car/car-register/car-register.component */ "./src/app/pages/car/car-register/car-register.component.ts");
/* harmony import */ var _pages_car_car_list_car_list_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./pages/car/car-list/car-list.component */ "./src/app/pages/car/car-list/car-list.component.ts");
/* harmony import */ var _pages_car_car_edit_car_edit_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./pages/car/car-edit/car-edit.component */ "./src/app/pages/car/car-edit/car-edit.component.ts");
...
/* harmony import */ var _components_confirm_modal_confirm_modal_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./components/confirm-modal/confirm-modal.component */ "./src/app/components/confirm-modal/confirm-modal.component.ts");
/* harmony import */ var _components_confirm_delete_modal_confirm_delete_modal_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./components/confirm-delete-modal/confirm-delete-modal.component */ "./src/app/components/confirm-delete-modal/confirm-delete-modal.component.ts");
/* harmony import */ var _pages_profile_profile_edit_profile_edit_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./pages/profile/profile-edit/profile-edit.component */ "./src/app/pages/profile/profile-edit/profile-edit.component.ts");
/* harmony import */ var _pages_station_station_edit_station_edit_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./pages/station/station-edit/station-edit.component */ "./src/app/pages/station/station-edit/station-edit.component.ts");
/* harmony import */ var _pages_node_node_edit_node_edit_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./pages/node/node-edit/node-edit.component */ "./src/app/pages/node/node-edit/node-edit.component.ts");
/* harmony import */ var _pages_station_station_config_station_config_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./pages/station/station-config/station-config.component */ "./src/app/pages/station/station-config/station-config.component.ts");
/* harmony import */ var _pages_node_node_config_node_config_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./pages/node/node-config/node-config.component */ "./src/app/pages/node/node-config/node-config.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _pages_dealer_dealer_information_dealer_information_component__WEBPACK_IMPORTED_MODULE_16__["DealerInformationComponent"],
                _pages_dealer_dealer_config_notification_dealer_config_notification_component__WEBPACK_IMPORTED_MODULE_17__["DealerConfigNotificationComponent"],
                _pages_user_user_list_user_list_component__WEBPACK_IMPORTED_MODULE_18__["UserListComponent"],
                _pages_user_user_create_user_create_component__WEBPACK_IMPORTED_MODULE_19__["UserCreateComponent"],
                _pages_user_user_edit_user_edit_component__WEBPACK_IMPORTED_MODULE_20__["UserEditComponent"],
                _pages_dashboard_car_dashboard_car_dashboard_component__WEBPACK_IMPORTED_MODULE_21__["CarDashboardComponent"],
                _pages_dashboard_car_timeline_car_timeline_component__WEBPACK_IMPORTED_MODULE_22__["CarTimelineComponent"],
                _pages_dashboard_car_config_notification_car_config_notification_component__WEBPACK_IMPORTED_MODULE_23__["CarConfigNotificationComponent"],
                _pages_menu_menu_menu_component__WEBPACK_IMPORTED_MODULE_24__["MenuComponent"],
                _pages_data_data_export_data_export_component__WEBPACK_IMPORTED_MODULE_25__["DataExportComponent"],
                _pages_beacon_beacon_list_beacon_list_component__WEBPACK_IMPORTED_MODULE_26__["BeaconListComponent"],
                _pages_beacon_beacon_register_beacon_register_component__WEBPACK_IMPORTED_MODULE_27__["BeaconRegisterComponent"],
                _pages_beacon_beacon_edit_beacon_edit_component__WEBPACK_IMPORTED_MODULE_28__["BeaconEditComponent"],
                _pages_car_car_register_car_register_component__WEBPACK_IMPORTED_MODULE_29__["CarRegisterComponent"],
                _pages_car_car_list_car_list_component__WEBPACK_IMPORTED_MODULE_30__["CarListComponent"],
                _pages_car_car_edit_car_edit_component__WEBPACK_IMPORTED_MODULE_31__["CarEditComponent"],
                _components_footer_footer_component__WEBPACK_IMPORTED_MODULE_32__["FooterComponent"],
                _components_confirm_modal_confirm_modal_component__WEBPACK_IMPORTED_MODULE_33__["ConfirmModalComponent"],
                _components_confirm_delete_modal_confirm_delete_modal_component__WEBPACK_IMPORTED_MODULE_34__["ConfirmDeleteModalComponent"],
                _pages_profile_profile_edit_profile_edit_component__WEBPACK_IMPORTED_MODULE_35__["ProfileEditComponent"],
                _pages_station_station_edit_station_edit_component__WEBPACK_IMPORTED_MODULE_36__["StationEditComponent"],
                _pages_node_node_edit_node_edit_component__WEBPACK_IMPORTED_MODULE_37__["NodeEditComponent"],
                _pages_station_station_config_station_config_component__WEBPACK_IMPORTED_MODULE_38__["StationConfigComponent"],
                _pages_node_node_config_node_config_component__WEBPACK_IMPORTED_MODULE_39__["NodeConfigComponent"]
            ],
            imports: [
...
module.exports = "<app-header>\n</app-header>\n<div class=\"uk-container\">\n    <nav class=\"uk-navbar-container uk-margin\" uk-navbar>\n        <div class=\"uk-navbar-left\">\n            <a class=\"uk-navbar-item uk-logo\" >{{'car register'|translate}}</a>\n        </div>\n        <div class=\"uk-navbar-right\">\n            <div class=\"uk-navbar-item\">\n                <button class=\"uk-button uk-button-default uk-border-rounded uk-margin-small-left\" (click)=\"registerCar()\">{{'register'|translate}}</button>\n                <button class=\"uk-button uk-button-default uk-border-rounded uk-margin-small-left\" (click)=\"cancelCar()\">{{'cancel'|translate}}</button>\n            </div>\n        </div>\n    </nav>\n    <form class=\"uk-form-stacked\">\n        <div class=\"uk-margin\">\n            <label class=\"uk-form-label\" for=\"licensePlate\">*{{'license plate'|translate}}</label>\n            <div class=\"uk-form-controls\">\n                <input class=\"uk-input\" name=\"licensePlate\" id=\"licensePlate\" type=\"text\" [(ngModel)]=\"form.licensePlate\">\n            </div>\n        </div>\n        <!-- <div class=\"uk-margin\">\n            <label class=\"uk-form-label\" for=\"brand\">*{{'brand'|translate}}</label>\n            <div class=\"uk-form-controls\">\n                <input class=\"uk-input\" name=\"brand\" id=\"brand\" type=\"text\" [(ngModel)]=\"form.brand\">\n            </div>\n        </div>\n        <div class=\"uk-margin\">\n            <label class=\"uk-form-label\" for=\"model\">*{{'model'|translate}}</label>\n            <div class=\"uk-form-controls\">\n                <input class=\"uk-input\" name=\"model\" id=\"model\" type=\"text\" [(ngModel)]=\"form.model\">\n            </div>\n        </div>\n        <div class=\"uk-margin\">\n            <label class=\"uk-form-label\" for=\"color\">*{{'color'|translate}}</label>\n            <div class=\"uk-form-controls\">\n                <input class=\"uk-input\" name=\"color\" id=\"color\" type=\"text\" [(ngModel)]=\"form.color\">\n            </div>\n        </div> -->\n        <div class=\"uk-margin\">\n            <label class=\"uk-form-label\" for=\"beacont\">*{{'beacon'|translate}}{{'id'|translate}}</label>\n            <div class=\"uk-form-controls\">\n                <input class=\"uk-input\" name=\"beaconId\" id=\"beacon\" type=\"text\" [(ngModel)]=\"form.beaconId\">\n            </div>\n        </div>\n    </form>\n</div>\n\n<div id=\"modal-confirm\" uk-modal>\n    <div class=\"uk-modal-dialog uk-modal-body\">\n        <p>{{'create user'|translate}}?</p>\n        <p class=\"uk-text-right\">\n            <button class=\"uk-button uk-button-primary uk-border-rounded uk-margin-small-left\" type=\"button\" (click)=\"modalConfirm()\">{{'confirm'|translate}}</button>\n            <button class=\"uk-button uk-button-default uk-border-rounded uk-margin-small-left\" type=\"button\" (click)=\"modalCancel()\">{{'cancel'|translate}}</button>\n        </p>\n    </div>\n</div>\n\n<div class=\"loading\" *ngIf=\"loading\">\n    <span class=\"uk-margin-small-right\" uk-spinner=\"ratio: 3\"></span>\n</div>"
...
var CarRegisterComponent = /** @class */ (function () {
    function CarRegisterComponent(router) {
        this.router = router;
        this.dealerId = '';
        this.loading = false;
        this.form = {
...
var CarTimelineComponent = /** @class */ (function () {
    ...
    CarTimelineComponent.prototype.onHeaderClick = function (event) {
        if (event == 'back') {
            this.router.navigate(['dashboard', 'car', this.dealerId]);
        }
    };
...
var ProfileEditComponent = /** @class */ (function () {
    function ProfileEditComponent(router, activeRoute, profileService, translate) {
        this.router = router;
        this.activeRoute = activeRoute;
    ...
    ProfileEditComponent.prototype.cancelProfile = function () {
        var _elementId = "#" + this.confirmModal.elementId;
        UIkit.modal(_elementId).$destroy(true);
        this.router.navigate(['menu']);
    };
    ProfileEditComponent.prototype.onClickConfirmModal = function (event) {
        var _this = this;
        var _elementId = "#" + this.confirmModal.elementId;
        if (event) {
            this.loading = true;
...
module.exports = __webpack_require__(/*! I:\宝马项目\bmw\APP\APP\src\main.ts */"./src/main.ts");
